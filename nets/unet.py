...
# 唔，也就是说这里受到了Transformer的启发？希望人为地引入一些时间信息？
# 那为什么要这么算呢？（顺便也可以考虑一下Transformer里位置编码的合理性）
...
# 嗯，这个注意力机制和Transformer里的注意力机制有什么区别呢？
# 为什么又要用attention呢？它可以提供什么显著的优越性吗？还是说只是为了增加模型的复杂度？
...
class ResidualBlock(nn.Module):
    def __init__(
        ...
        self.class_bias = (
            nn.Embedding(num_classes, out_channels) if num_classes is not None else None
        )
